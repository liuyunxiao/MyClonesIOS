...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response
{
    ...
    if ([delegate respondsToSelector:@selector(storeHttpHeaderFields:headeFields:)])
    {        
        [delegate performSelector:@selector(storeHttpHeaderFields:headeFields:) withObject:self withObject:headerDic];
    }
}
