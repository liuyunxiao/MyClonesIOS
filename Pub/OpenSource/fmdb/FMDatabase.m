        ...
        if (last == '%') {
            switch (current) {
                ...
                case 'c':
                    ...
                    arg = [NSString stringWithFormat:@"%c", va_arg(args, int)]; break;  // yebw
                case 's':
                ...
                case 'h':
                    ...
                    if (i < length && [sql characterAtIndex:i] == 'i') {
                        ...
                        arg = [NSNumber numberWithShort:(short)va_arg(args, int)]; // yebw
                    }
                    else if (i < length && [sql characterAtIndex:i] == 'u') {
                        //arg = [NSNumber numberWithUnsignedShort:va_arg(args, unsigned short)];
                        arg = [NSNumber numberWithUnsignedShort:(unsigned short)va_arg(args, unsigned int)];
                    }
                    else {
                        i--;
                    }
                ...
                case 'g':
                    ...
                    arg = [NSNumber numberWithFloat:(float)va_arg(args, double)]; break; // yebw
                case 'l':
                    i++;
                    if (i < length) {
