...
- (void)finishCropping {
    ...
    cropRectinImage.origin.x=cropRectinImage.origin.x+(320-WIDTH_)/2*(cropRectinImage.size.width/320);
    cropRectinImage.origin.y=cropRectinImage.origin.y+(320-HEIGHT_)/2*(cropRectinImage.size.width/320);
    cropRectinImage.size.width=cropRectinImage.size.width*(WIDTH_/320.f);
    cropRectinImage.size.height = cropRectinImage.size.height*(HEIGHT_/320.f);
...
//    self.croppedImage=[UIImage imageWithCGImage:tmp];
