...
//周边商家
- (Task *)queryNearbyShop:(NSString*)catId latitude:(double)latitudu longitude:(double) longitude distance:(NSInteger)distance page:(NSInteger)aPage size:(NSInteger)aSize observer:(id)aObserver selector:(SEL)aSelector context:(id)aContext;
